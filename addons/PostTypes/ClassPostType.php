...
>>>>>>> 42c470d4581f2f8c0d1ceef9eee354f002e2c343
					...
					array(
						'type' => 'text',
						'validation' => 'text',
						'title' => __( 'Tentative Date', 'childtheme' ),
						'name' => '_class__tentative_date',
						'desc' => 'This field is to be used when dates have not been applied. If dates have been applied please leave this empty.',
					),
					array(
						'type' => 'select',
						'validation' => 'select',
					...
					array(
						'type' => 'select',
						'validation' => 'select',
						'title' => __( 'Show Sessions', 'childtheme' ),
						'name' => '_class__show_session',
						'options' => array(
							'Yes' => 1,
							'No' => 0
						)
